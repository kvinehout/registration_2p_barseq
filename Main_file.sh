...
#baylor sample 2
python Main_2d_3d.py --remotesubjectpath='/home/imagestorage/xichen/20210504BCM25618/lectin_2/' --localsubjectpath='/Users/kaleb/Documents/CSHL/2d_3D_linear_reg/' --image_type='P-Cy5' --X_dir='right' --Y_dir='top' --seq_dir='top' --opticalZ_dir='bottom' --input_overlap=0.15 --server='zadorstorage4.cshl.edu' --user='imageguest' --password='zadorlab' --output='registration_baylor2_2p' --extra_figs=True --max_Z_proj_affine=True --find_rot=True --rigid_2d3d=True --denoise_all=False
